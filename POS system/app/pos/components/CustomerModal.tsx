                          ...
                          >
                            ...
                            <div className="flex items-center gap-4">
                              <div className="text-right min-w-[96px]">
                                <div className="text-xs font-medium text-zinc-500 capitalize">Dívida</div>
                                <div
                                  className={`text-sm font-mono font-bold ${
                                    Number(customer.debt_balance ?? 0) > 0 ? 'text-amber-400' : 'text-zinc-500'
                                  }`}
                                >
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-zinc-500">
                  Esta ação não pode ser desfeita. Clientes com documentos ou dívida associados não podem ser
                  apagados.
                </p>
              </div>
