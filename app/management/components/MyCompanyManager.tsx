...
function FieldRow({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-[minmax(160px,220px)_1fr] gap-x-4 gap-y-1 items-center border-b border-zinc-800/60 py-2.5">
      <label className={`text-[11px] font-semibold uppercase tracking-wide ${required ? 'text-rose-300/90' : 'text-zinc-500'}`}>
        {label}
      </label>
          ...
          <div className="max-w-3xl pt-4 space-y-6">
            <section>
              ...
              <div className="rounded border border-zinc-800/80 bg-[#141414] px-3">
                ...
                <FieldRow label="Building number">
                  <input
                ...
                <FieldRow label="Additional street name">
                  <input
                    className={inputCls()}
                    value={form.additionalStreet}
                    onChange={(e) => setForm((f) => ({ ...f, additionalStreet: e.target.value }))}
                  />
                </FieldRow>
                <FieldRow label="Plot identification">
                  <input
                    className={inputCls()}
                    value={form.plotIdentification}
                    onChange={(e) => setForm((f) => ({ ...f, plotIdentification: e.target.value }))}
                  />
                </FieldRow>
